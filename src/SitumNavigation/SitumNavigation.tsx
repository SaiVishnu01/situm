...
const Screen: React.FC = () => {
  ...
  SitumPlugin.onEnterGeofences((items: any) => {
    console.log(
      'Situm > example > Detected Entered geofences: ' + JSON.stringify(items),
    );
  });
  ...
  return (
    <MapView
      ...
      configuration={{
        ...
        remoteIdentifier: 'hudini_testing',
        language: 'en',
      }}
      onLoad={onLoad}
...
const SitumNavigation: React.FC = () => {
  const isDarkMode = useColorScheme() === 'dark';
  const backgroundStyle = {
    backgroundColor: isDarkMode ? Colors.darker : Colors.lighter,
  };

  //return <NavigateToPOI />;
...
export default SitumNavigation;
